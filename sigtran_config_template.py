"""
Production SIGTRAN Configuration Template

This file serves as a template for configuring SIGTRAN endpoints in a production environment.
Update the values with information provided by your carrier.
"""
